...
const GateExamPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-gameTeal selection:text-white -mt-20">
      ...
      <section className="relative pt-20 pb-20 lg:pt-24 lg:pb-24 overflow-hidden bg-black text-white">
         ...
         <div className="max-w-[1280px] mx-auto px-8 md:px-10 lg:px-12 relative z-10 text-center">
            ...
            >
               ...
               <p className="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto mb-8 leading-relaxed font-medium">
      ...
      {/* FULL WIDTH STICKY SUB-NAVIGATION - COMPACT */}
      <div className="sticky top-[58px] z-40 w-full bg-gameTeal shadow-md border-b border-gameTealDark">
         <div className="max-w-[1280px] mx-auto px-8 md:px-10 lg:px-12">
            <div className="flex items-center justify-between h-12">
               {/* Links */}
               <div className="flex items-center gap-1 md:gap-4 overflow-x-auto teal-scrollbar mask-gradient-right w-full md:w-auto pb-1">
                  {[
                     { label: "Overview", id: "overview" },
                     { label: "Gate Advantages", id: "advantages" },
                     { label: "Updates", id: "updates" },
                     { label: "Marks Distribution", id: "distribution" },
                     { label: "Paper Combination", id: "combinations" },
                     { label: "Dates", id: "important-dates" },
                     { label: "Schedule", id: "exam-schedule" },
                     { label: "Cutoffs & Score", id: "cutoffs" },
                     { label: "GATE Organisers", id: "organisers" },
                     { label: "PSUs through GATE", id: "psus" },
                     ...
                     <button
                        ...
                        className="text-white/90 text-xs md:text-sm font-bold whitespace-nowrap hover:text-gameGold hover:bg-white/10 px-3 py-1.5 rounded-lg transition-all"
                     >
                        {item.label}
                     </button>
                  ))}
               ...
               <div className="hidden md:flex items-center gap-4 pl-4 border-l border-white/10 shrink-0">
                  <button 
                     className="bg-gameGold text-black px-5 py-1.5 rounded-full text-xs font-black uppercase tracking-wider hover:bg-white transition-all shadow-[0_0_10px_rgba(242,197,55,0.3)] flex items-center gap-2"
                  >
