    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-gameTeal selection:text-white -mt-20">
      ...
      <section id="highlights" className="py-16 bg-slate-50 relative overflow-hidden scroll-mt-32 border-t border-slate-200">
         ...
         <div className="max-w-[1280px] mx-auto px-8 md:px-10 lg:px-12 relative z-10">
            ...
            {/* ROADMAP PATHWAY UI - alternating photo/text rows, matching the ESE, PSU R&D and GATE Advantage roadmaps */}
...
const SscChoiceAdvantageRow: React.FC<{
  index: number;
  icon: any;
  title: string;
  description: string;
      ...
      <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-12 lg:gap-20`}>
        ...
        >
          <div className="relative group">
            ...
            <div className="relative rounded-[3rem] overflow-hidden border-4 border-white shadow-2xl aspect-[11/8] bg-gameTealDark">
              {!imgFailed && (
              ...
              <div className="absolute bottom-8 left-8 right-8 text-white opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all">
                <p className="text-sm font-black uppercase tracking-widest text-gameGold mb-2">SSC-JE Advantage</p>
