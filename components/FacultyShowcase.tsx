...
const FacultyShowcase: React.FC = () => {
  return (
    <section className="py-12 lg:py-16 bg-slate-50 overflow-hidden relative border-t border-slate-100">
       {/* Background Elements */}
       ...
       <div className="max-w-[1280px] mx-auto px-6 md:px-10 lg:px-12 relative z-10">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
             ...
             <div className="lg:w-[45%] order-2 lg:order-1">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-gameTeal/10 text-gameTeal text-[10px] font-black uppercase tracking-widest rounded-full mb-5">
                   <Award size={12} /> World Class Faculty
                </div>
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-slate-900 mb-5 leading-tight">
                ...
                <div className="text-slate-600 text-sm leading-relaxed mb-8 bg-white p-5 rounded-2xl border border-slate-100 shadow-sm">
             ...
             <div className="lg:w-[55%] relative order-1 lg:order-2">
                ...
                <div className="hidden lg:block relative h-[520px] w-full">
                   ...
                   <div className="absolute top-10 right-0 w-[55%] h-[420px] z-10">
                   ...
                   {/* Main Image (Front) */}
                   <div className="absolute top-0 left-4 w-[60%] h-[460px] z-20">
