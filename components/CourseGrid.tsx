...
const CourseGrid: React.FC<CourseGridProps> = ({ selectedExam, setSelectedExam, searchTerm, setSearchTerm }) => {
  ...
  const allCourses = [
    ...
    // Govt R&D
    {
      ...
      image: "/images/courses/ssc-je.png",
      duration: "6 Months",
    ...
    },
    {
      ...
      image: "/images/courses/rrb-je.png",
      duration: "8 Months",
    ...
    // PSUs
    {
      ...
      image: "/images/courses/state-ae.png",
      duration: "12 Months",
    ...
    // SSC JE
    {
      ...
      image: "/images/courses/iit-jee.png",
      duration: "12 Months",
    ...
    },
    {
      ...
      image: "/images/courses/non-tech.png",
      duration: "12 Months",
    ...
    // State AE / JE
    {
      ...
      image: "/images/courses/mechanical.png",
      duration: "10 Months",
